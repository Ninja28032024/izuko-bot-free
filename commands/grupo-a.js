module.exports = {
    ...
    async execute({ lux, msg, from, isGroup, sender, settings, areJidsSameUser }) {
        ...
        if (!senderIsAdmin) {
            return await lux.sendMessage(from, { text: 'Mestre, apenas administradores podem abrir o portão.' }, { quoted: msg });
        }
        if (!botIsAdmin) {
        ...
        await lux.sendMessage(from, { text: '🗣️ *Grupo Aberto!* Mestre, os portões foram abertos. Todos os membros agora podem enviar mensagens.' }, { quoted: msg });
    }
};
